...
El objetivo de este trabajo es un entorno en
...
_Pandoc_ es una biblioteca _Haskell_ @marlow2010haskell para convertir de un
formato de marcado ligero a otro, y una herramienta de línea de comandos que
accede a las funciones en esta biblioteca para convertir entre numerosos
...
comprender lo que encuentran y usarlo para realizar tareas @das.

Trabar de este modo habilita separar contenido, referencias, estilos y procesos.
...
Lo que distingue a Markdown de muchas otras sintaxis de marcado ligero, es su
