...
En este capitulo se describe el método utilizado

Primero se introduce al proceso de integración de diferentes herramientas

Luego gráficos,
luego citas y referencias
luego notación matemáticas.


El desarrollo de este trabajo fue realizado

ota al pie: Como conseguir una instalcion funcional de 
